...
def main():
    ...
    st.markdown("<p class='font-family'>Are you planning a trip to Saudi Arabia but don't know where to start? Have you ever seen a photo of a place you like and wondered where you can find something similar in Saudi Arabia?(supports English and Arabic languages).\n\n</p>", unsafe_allow_html=True)
